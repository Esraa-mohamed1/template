...
export default function HomeTestimonials({
  ...
  return (
    <section className="px-6 py-24 bg-white text-center rounded-[inherit]" dir="ltr">
      <div className="max-w-4xl mx-auto relative">
        <h2 className="text-3xl font-bold mb-12 text-gray-800">{title}</h2>
        ...
        <div className="text-gray-600 text-lg md:text-xl font-medium italic leading-relaxed px-8 relative">
          <span className="text-blue-200 text-6xl absolute -top-10 left-0 select-none">“</span>
          {testimonialText}
          <span className="text-blue-200 text-6xl absolute -bottom-10 right-0 select-none">”</span>
        </div>
      </div>
    </section>
  );
