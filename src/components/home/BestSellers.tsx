...
const BestSellers = ({ onProductClick }: BestSellersProps) => {
  const products: Product[] = [
    {
      id: "best-1",
      slug: "legendary-whitetails-womens-outfitter-hoodie",
      ...
      description:
        "The Legendary Whitetails Women's Outfitter Hoodie is built for comfort and style. Featuring a soft blend of materials, this hoodie is perfect for crisp autumn mornings or layering during winter.",
      gallery: [
    ...
    {
      id: "best-2",
      slug: "autumn-harajuku-print-hoodies-women-sailor",
      ...
      description:
        "Embrace the Harajuku style with this unique sailor-inspired hoodie.",
      gallery: [
    ...
    {
      id: "best-3",
      slug: "womens-pullover-long-sleeve-plaid-hoodie",
    ...
    {
      id: "best-4",
      slug: "casual-v-neck-floral-print-chiffon-blouse",
